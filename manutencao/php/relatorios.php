...
include('sidebar.php');
    ...
    $sql_code_user = "SELECT * FROM usuarios "; //depois adicionar WHERE nivel = '3'
    ...
    if(!empty($dados)){
        ...
        if(!empty($dados['data_ini']) && !empty($dados['data_fim'])){
            ...
            inicio_apontamento,
            fim_apontamento,
            total_horas_apontadas_formatado,
            total_horas_paradas_formatado,
            diferenca_horas
        FROM (
            SELECT 
                apontamentos.id_os,
            ...
            WHERE
                apontamentos.id_prestador = :id_usuario
                AND apontamentos.data_inicio >= :data_ini  
                AND apontamentos.data_fim <= :data_fim
            GROUP BY 
        ...
        WHERE
            ...
            AND apontamentos.data_fim <= :data_fim;";
                ...
                $sql_form->bindParam(':id_usuario', $_POST['nome_colab']);
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="total_apontado"><?php echo $row['total_horas_apontadas_formatado'] ?></td>
                    <td class="total_apontado"><?php echo$row['total_horas_paradas_formatado'] ?></td>
                    <td class="total_liquido"><?php echo$row['diferenca_horas'] ?></td>
