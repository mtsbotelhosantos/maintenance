...
include("../../conexao.php");
    ...
    $results = $sql_code->fetchAll(PDO::FETCH_ASSOC); 
       ...
       usuarios.id
        ...
        WHERE 
            apontamentos.id_os = '$id' AND apontamentos.id_prestador = '$usuario';"; 
        ...
        <body>
            ...
            <div class="principal">
                ...
                <div class="header">
                                ...
                                <div class="info-os">
                                    <span> <label class="titulos_os">OS:</label> <?php echo $row['id'] ?> <p class="tipo_os">Programada</p></span>
                                </div>
                                <div class="info-os">
                                    <span><label class="titulos_os">Equipamento:</label></span> <span><?php echo $row['nome_equip'] ?></span>
                                    
                                </div>
                            
                            
                                <div class="info-os">
                                    <span><label class="titulos_os">Data Criação:</label> <?php echo date('d-m-Y H:i', strtotime($row["data_abertura"])) ?></span>
                                    
                                   
                                    <span><label class="titulos_os">Usuário Criação:</label><?php echo $row['nome_abertura'] ?></span>
                                    <span><label class="titulos_os">Data Programada:</label> <?php echo date('d-m-Y H:i', strtotime($row["data_programada"])) ?> <a href="altera_plano_manutencao.php?id=<?php echo $id ?>" id="edit_data" class="material-symbols-outlined">edit</a></span> 
